...
const config = {
    ...
    info:{
        website: 'https://github.com/ayyilopyu4-arch/AlyaMD'
    },
    ...
    session: {
        pairingNumber: '628xxxxxxxx',   // Nomor WA yang akan di-pair
        usePairingCode: true              // true = Pairing Code, false = QR Code
    },

    bot: {
        name: '𝗢𝗨𝗥𝗜𝗡 𝗠𝗗',                 // Nama bot
        version: '1.8.0',                 // Versi bot
...
function isPremium(number) {
    ...
    return premiumList.some(premium => {
