...
const { hasAccessToServer, getUserRole, VALID_SERVERS } = require('../../src/lib/cpanelRoles')
const fs = require('fs')

const RAM_OPTIONS = ['1gb', '2gb', '3gb', '4gb', '5gb', '6gb', '7gb', '8gb', '9gb', '10gb', 'unli']
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        await sock.sendMessage(targetUser, { image: fs.readFileSync('./assets/images/ourin-v8.jpg'), caption: detailTxt, contextInfo: { mentionedJid: [targetUser], isForwarded: true, forwardingScore: 999 },
            interactiveButtons: [
                {
                    name: 'cta_copy',
